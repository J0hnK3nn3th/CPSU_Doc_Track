...
_ACTIVITY_ACTION_DISPLAY = {
    ...
    'AUTH_LOGOUT': 'LOG OUT',
    'SYSTEM_CONFIG_CREATE_CATEGORIES': 'ADDED DOCUMENT TYPE',
    'SYSTEM_CONFIG_CREATE_OFFICES': 'ADDED OFFICE/DEPARTMENT',
    'SYSTEM_CONFIG_CREATE_USERSROLES': 'ADDED USERS AND ROLES',
}
